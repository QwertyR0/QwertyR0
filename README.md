...
- At **Teknofest, Turkey's largest technology festival**, [my team](https://www.instagram.com/uhal_iha/) and I developed an **Autonomous Quadcopter** capable of **site detection** via image processing and **deploying objects** at these sites.
- I attend game jams. While it’s not my main strength, I managed to secure **first place** with [my team](https://github.com/Hammer-Drill-Games) at an on-site event. Here are some of the games I worked on: [Tonguer](https://k-lemon.itch.io/tonguer), [16! Platformer](https://qwertyr0.itch.io/16-platformer), [Slice Sizzle Showdown](https://qwertyr0.itch.io/sliced)
